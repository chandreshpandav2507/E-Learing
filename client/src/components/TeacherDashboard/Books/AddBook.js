...
import {createBook} from '../../../store/actions/teacher'
    ...
    return (
      ...
      >
        ...
        <Modal.Footer>
            ...
            <Button variant='contained' color="primary" onClick={handleSubmit}>Add Book</Button>
        </Modal.Footer>
      </Modal>
    );
  }
...
const mapDispatchToProps = dispatch => {
    return {
        addBook: (formData) => dispatch(createBook(formData))
    }
}
